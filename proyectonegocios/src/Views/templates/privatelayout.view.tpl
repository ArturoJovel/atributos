...
<body>
  <header>
    ...
    <nav id="inav" class="cnav">
        <ul>
            ...
            <li><a href="index.php?page=gnrl_carrito">Carrito</a></li>
            <li><a href="index.php?page=mnt_productos">Mantenimiento Productos</a></li>
            <li id="Marcas">Catálogo
                <ul class="marcas">
                    <li id="m1">Caballeros
                        <ul class="nieto">
                            <li><a href="index.php?page=gnrl_catalogo" >Zapatillas</a></li>
                            <li ><a href="catalogos_copy.html" >Tenis</a></li>
                    <!--        <li><a href="catalogos_copy2.html" >Pulseras</a></li> -->
                        </ul>
                    </li>
                    <li id="m2">Damas
                        <ul class="nieto">
                            <li ><a href="catalogos.html" >Tacones</a></li>
                            <li ><a href="catalogos_copy.html" >Zapatillas</a></li>
                            <li><a href="catalogos_copy2.html" >Tenis</a></li>
                        </ul>
                    </li>
                    <li id="m3">Niños
                        <ul class="nieto">
                            <li><a href="catalogos.html" >Zapatillas</a></li>
                            <li ><a href="catalogos_copy.html" >Tenis</a></li>
                    <!--        <li><a href="catalogos_copy2.html" >Pulseras</a></li> -->
                        </ul>
                    </li>
  ...
  <footer >
    <section class="logo">
        <img src="/{{BASE_DIR}}/public/img/logo.png" alt="pandora" style="width:auto;">
    </section>
 ...
 <div class="container-footer">
     <div class="footer">
         <div class="copyright">
             <p>&copy; Todos los Derechos Reservados | TrotamundosHN</p>
         </div>
