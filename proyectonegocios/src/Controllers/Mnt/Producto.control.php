...
namespace Controllers\Mnt;
    ...
    class Producto extends  \Controllers\PublicController{
        ...
        public function run(): void{
            ...
            $viewData["atributosCod"] = 0;
            $viewData["atributosDsc"] = "";
			$viewData["atributosEst"] = "";
			$viewData["atributosCnt"] = 0;
            ...
            if($this->isPostBack()){
                ...
                $viewData["atributosCod"]= isset($_GET["id"])? $_GET["id"] : 0;
            }

            if($viewData["mode"] == "INS"){
                $viewData["ModalTittle"] = "Agregando nuevo atributo";
                $viewData["showCommitBtn"]  = $viewData["mode"] == "INS";
            }else{
                $ItemTable = \Dao\ProductoPanel::getProductoById($viewData["atributosCod"]);
                if (!$ItemTable) {
                  \Utilities\Site::redirectToWithMsg(
                        "index.php?page=mnt_productos",
